...
public class RedSideBackstage extends LinearOpMode{
...
//        drive.setPoseEstimate(new Pose2d(-35, -60, Math.toRadians(90)));
        ...
        drive.followTrajectorySequence(preboardRedBackstage);
        sleep(100);
        drive.followTrajectorySequence(postboardRedBackstage);

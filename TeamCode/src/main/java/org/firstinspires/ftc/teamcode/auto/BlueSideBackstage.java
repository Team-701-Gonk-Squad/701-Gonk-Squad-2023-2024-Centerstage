...
public class BlueSideBackstage extends LinearOpMode{
...
//        drive.setPoseEstimate(new Pose2d(-35, -60, Math.toRadians(90)));
        ...
        drive.followTrajectorySequence(preboardBlueBackstage);
        sleep(100);
        drive.followTrajectorySequence(postboardBlueBackstage);

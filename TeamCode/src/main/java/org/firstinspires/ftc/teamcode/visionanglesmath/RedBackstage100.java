...
@Autonomous
public class RedBackstage100 extends OpMode {
    ...
    public void loop() {
        ...
        TrajectorySequence start_centerstriprelease = drive.trajectorySequenceBuilder(new Pose2d(12, -60, Math.toRadians(90)))
                .lineToSplineHeading(new Pose2d(16, -33.5, Math.toRadians(90)))
                .build();
        ...
        TrajectorySequence start_rightstriprelease = drive.trajectorySequenceBuilder(new Pose2d(12, -60, Math.toRadians(90)))
